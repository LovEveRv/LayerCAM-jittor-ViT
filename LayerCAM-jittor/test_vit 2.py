...
from utils import visualize, basic_visualize, load_image, apply_transforms
...
def get_arguments():
    ...
    parser.add_argument('--img_path', type=str, default=None, help='Path of test image')
    parser.add_argument('--blocks', type=list, default=[1, 2, 5, 6], help='The cam generation blocks')
